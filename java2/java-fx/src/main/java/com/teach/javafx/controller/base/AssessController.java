...
public class AssessController extends ToolController{
    @FXML
    ...
    public void initialize() {
        ...
        req.put("numName","");
        res = HttpRequestUtil.request("/api/assess/getSingleAssessList",req); //从后台获取所有学生信息列表集合
    ...
    protected void onSaveButtonClick() {
        ...
        req.put("assessId", assessId);
        req.put("form", form);
        DataResponse res = HttpRequestUtil.request("/api/assess/assessSingleEditSave",req);
        if(res.getCode() == 0) {
